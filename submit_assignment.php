					...
					<!--     <ul class="breadcrumb">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><b>Submitted Assignments</b></div>
                                <div id="" class="muted pull-right"><a href="assignment_student.php<?php echo '?id='.$get_id; ?>"><i class="icon-arrow-left"></i> Back</a></div>
                            </div>
