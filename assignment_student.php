					   ...
					   <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								?>
								<div id="" class="muted pull-left">Uploaded Assignments</div>
								...
								?>
									...
									?>                              
										<tr>
										 ...
										 ?>
										  <a data-placement="top" title="Download/View Assignment" id="<?php echo $id; ?>download"  class="btn btn-info" href="<?php echo $row['floc']; ?>"><i class="fa fa-eye"></i> View</a>
										<?php } ?>
										 <button  data-placement="top" title="Submit Assignment" id="<?php echo $id; ?>submit" class="btn btn-success" name="btn_assign"><i class="icon-upload icon-large"></i> Submit</button>
										 </form>
										 </td>                                      
