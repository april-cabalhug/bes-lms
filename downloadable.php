							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									...
									<?php
										...
										if ($count == '0'){ ?>
											<div class="alert alert-info"><i class="icon-info-sign"></i> Currently you did not upload any lecture</div>
  								...
  								<form action="copy_file.php" method="post">
									...
									?>                              
										<tr id="del<?php echo $id; ?>">
                                         ...
                                         <td width="40">
										 <a  data-placement="top" title="Preview/Download" id="<?php echo $id; ?>preview" href="<?php echo $row['floc']; ?>"><i class="fa fa-eye" style="font-size:15px"></i></a>
										 <a  data-placement="top" title="Remove" id="<?php echo $id; ?>remove" href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-remove icon-large"></i></a>
