...
<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $mail->Username = 'bes.lmsonline@gmail.com';
        // Gmail Password
        $mail->Password = 'whiayzbrurerwtoz';
        $mail->SMTPSecure = 'ssl';
        $mail->Port = '465';
        ...
        $mail->addAddress('admin@bes-lms.com');
        ...
        $mail->send();
        echo '<script>alert("Thankyou! for contacting us, We will get back to you soon!")</script>';
    } catch (Exception $e) {
...
?>
     ...
     <form id="verify-email-username" class="form-signin" method="post">
        <center><h3 class="form-signin-heading">Feedback/Report a Problem</h3></center>
        <input type="text" class="input-block-level" id="name" name="name" placeholder="Name" required>
        <input type="text" class="input-block-level" id="email" name="email" placeholder="Email" required>
        <input type="text" class="input-block-level" id="subject" name="subject" placeholder="Subject" required>
		<textarea name="message" class="my_message" style="resize:none; width:285px;" id="message" placeholder="Message" rows="5" required></textarea><br>
						...
						<span class="icon-bar"></span>
							...
							<div class="nav-collapse collapse">
                        		...
                        		<li><a href="programs.php"></i>&nbsp;Programs</a></li>
                        			<li class="divider-vertical"></li>
                        		<li class="active"><a href="feedback.php"></i>&nbsp;Feedback</a></li>
                        			<li class="divider-vertical"></li>
								</ul>
