                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<tr>
										 ...
										 <button data-placement="top" title="View Student who submit Assignment" id="<?php echo $id; ?>view" class="btn btn-success"><i class="icon-folder-open-alt icon-large"></i></button>
										...
										?>
										 <a data-placement="top" title="Preview" id="<?php echo $id; ?>preview"  class="btn btn-info" href="<?php echo $row['floc']; ?>"><i class="fa fa-eye" style="font-size:15px"></i></a>
										<?php } ?>
