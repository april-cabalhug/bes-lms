					...
					<!--     <ul class="breadcrumb">
                        ...
                        <div id="block_bg" class="block">
							...
							?>
                                ...
                                <div id="" class="muted pull-left"><h4>My Quiz List</h4></div>
                            </div>
                            <div class="block-content collapse in" style="background:#ffe7e6">
                                <div class="span12">
									...
									?>                              
										<tr>                     
                                         ...
                                         <td width="200">
										<?php if ($grade == ""){ ?>
											<a  data-placement="bottom" title="Take This Quiz" id="<?php echo $id; ?>Download" href="take_test.php<?php echo '?id='.$get_id ?>&<?php echo 'class_quiz_id='.$id; ?>&<?php echo 'test=ok' ?>&<?php echo 'quiz_id='.$quiz_id; ?>&<?php echo 'deadline='.$deadline;	 ?>"><i class="icon-check icon-large"></i> Take This Quiz</a>
										<?php }else{ ?>
											<b>Already Taken Score <?php echo $grade; ?></b>
										<?php } ?>
										</td><td>
										<?php
											if($deadline < $date_taken){ ?>
												<b><font color = "red">LATE</font></b>
											<?php } ?>
										</td>            
