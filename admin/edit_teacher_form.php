       ...
       <a href="teachers.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Teacher</a>
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form method="post">
									...
									<?php
									$query = mysqli_query($conn,"select * from teacher LEFT JOIN department ON department.department_id = teacher.department_id where teacher_id = '$get_id' ")or die(mysqli_error());
									...
									?>
                                          ...
                                          <div class="controls">
											...
											<?php
											$query_teacher = mysqli_query($conn,"select * from teacher LEFT JOIN department ON department.department_id = teacher.department_id where teacher_id = '$get_id'")or die(mysqli_error());
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['email']; ?>"  name="email" id="focusedInput" type="text" placeholder = "Email Address" required>
                                          </div>
                                        </div>
				   ...
				   <?php
                            if (isset($_POST['update'])) {
								...
								mysqli_query($conn,"update teacher set firstname = '$firstname' , lastname = '$lastname' , department_id = '$department_id', email = '$email' where teacher_id = '$get_id' ")or die(mysqli_error());	
