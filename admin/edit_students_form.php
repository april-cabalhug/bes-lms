       ...
       <a href="students.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Student</a>
                        ...
                        <div class="block">
							...
							?>
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input name="un" value="<?php echo $row['username']; ?>" class="input focused" minlength="12" maxlength="12" id="focusedInput" type="text" placeholder = "LRN Number" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="email"  value="<?php echo $row['email']; ?>" class="input focused" id="focusedInput" type="text" placeholder = "Email Address" required>
                                          </div>
                                        </div>
											<div class="control-group">
                                          <div class="controls">
	      ...
	      <?php
                            if (isset($_POST['update'])) {
								...
								mysqli_query($conn,"update student set username = '$un' , firstname ='$fn' , lastname = '$ln' , class_id = '$cys', email = '$email' where student_id = '$get_id' ")or die(mysqli_error());
