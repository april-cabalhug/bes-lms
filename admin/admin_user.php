                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_users.php" method="post">
									...
									<a data-toggle="modal" href="#user_delete" id="delete"  class="btn btn-danger" name=""><i class="fa fa-user-times"></i></a>
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($conn,"select * from users where status='active'")or die(mysqli_error());
