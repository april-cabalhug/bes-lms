                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
							    ...
							    <form class="form-horizontal" method="post">
										...
										<div id="opt11">
<?php
	$sqlz = mysqli_query($conn,"SELECT * FROM answer WHERE quiz_question_id = ".$_GET['quiz_question_id']."");
...
<div id="opt12">
	...
	<input name="correctt" <?php if($row['answer'] == 'False'){ echo 'checked'; }?> value="False" type="radio">False<br /><br />
		...
		mysqli_query($conn,"update quiz_question set question_text = '$question',date_added = NOW(),answer = '".$_POST['correctm']."',question_type_id = '$type' where quiz_question_id = '$quiz_question_id'")or die(mysqli_error());
		...
		mysqli_query($conn,"update answer set answer_text = '$ans1',choices = '$A' where answer_id = '$answer_id'")or die(mysqli_error());

		mysqli_query($conn,"update answer set answer_text = '$ans2',choices = '$B' where answer_id = '$answer_id'")or die(mysqli_error());

		mysqli_query($conn,"update answer set answer_text = '$ans3',choices = '$C' where answer_id = '$answer_id'")or die(mysqli_error());
		
		mysqli_query($conn,"update answer set answer_text = '$ans4',choices = '$D' where answer_id = '$answer_id'")or die(mysqli_error());
