    ...
    <div class="container" style="position: relative">
		<div class="row-fluid">
			...
			<form id="signin_student" class="form-signin" method="post">
    			...
    			<input type="text" class="input-block-level" id="username" minlength="12" maxlength="12" name="username" placeholder="Username (LRN Number)" required>
			...
			jQuery("#signin_student").submit(function(e){
					...
					$.ajax({
						...
						var delay = 2000;
							...
							var delay = 2000;
							setTimeout(function(){ window.location = 'signup_student.php'  }, delay);
						}else
						{
							$.jGrowl("Something Went Wrong!", { header: 'Sign Up Failed' });
							var delay = 2000;
								setTimeout(function(){ window.location = 'signup_student.php'  }, delay);
						}
						}
