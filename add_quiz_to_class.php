...
<body>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">Deadline of Submission</label>
											<div class="controls">
											<input type="datetime-local" class="span4" name="date01" id="date01" placeholder="Due Date" required/>
											</div>
										</div>
				...
				<tbody>
					...
					<?php } ?>
										...
										if (isset($_POST['save'])){
											...
											$name_notification  = 'Add Quiz file';
													
											$N = count($id);
											for($i=0; $i < $N; $i++)
											{
												mysqli_query($conn,"insert into class_quiz (teacher_class_id,quiz_id,deadline) values('$id[$i]','$quiz_id','$deadline')")or die(mysqli_error());
		...
		<script type="text/javascript">
            $(function(){
                ...
                document.getElementsByName("date01")[0].min = today;
            });
        </script>
