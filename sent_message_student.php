					...
					<!-- 
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left">Sent Messages</div>
                                <div id="" class="muted pull-right"><a href="dashboard_student.php"><i class="icon-arrow-left"></i> Back to Dashboard</a></div>
                            </div>
                            <div class="block-content collapse in">
								...
								<?php
								 ...
								 ?>
											<div class="post"  id="del<?php echo $id; ?>" style="background:#ffe7e6">
